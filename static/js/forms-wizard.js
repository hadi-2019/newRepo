        ...
        templates: {
            buttons: function(){
                ...
                return '<div class="clearfix">' +
                    '<button class="btn btn-secondary" data-target="#'+this.id+'" data-wizard="back">'+" قبلی "+'</button>' +
                    '<button class="btn btn-primary float-right" data-target="#'+this.id+'" data-wizard="next">'+" بعدی "+'</button>' +
                    '                   <button class="btn btn-primary float-right" data-target="#'+this.id+'" data-wizard="finish">'+" ذخیره "+'</button>' +
                '</div>';
            }
        },
        onInit: function(){
